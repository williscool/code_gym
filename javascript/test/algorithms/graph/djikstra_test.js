...
var Djikstra = require('../../../algorithms/graph/djikstra.js').naive;
...
describe('Naive Djikstra', function(){
  ...
  var traversal = new Djikstra(graph,0);
  ...
  describe('shortest path', function () {
    ...
    it("returns verticies in correct order for a valid path", function () {
      assert.deepEqual(shortest_path_info[0], {distance: "0.00", predecessor: null});
      assert.deepEqual(shortest_path_info[2], {distance: "0.26", predecessor: 0});
      assert.deepEqual(shortest_path_info[7], {distance: "0.60", predecessor: 2});
      assert.deepEqual(shortest_path_info[3], {distance: "0.99", predecessor: 7});
      assert.deepEqual(shortest_path_info[6], {distance: "1.51", predecessor: 3});
